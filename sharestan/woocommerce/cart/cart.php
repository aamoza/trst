...
<div class="sharestan-container cart-page-container">
				...
				<tbody>
					...
					<tr>
						<td colspan="6" class="actions">
							<button type="submit" class="button sharestan-btn btn-outline" name="update_cart" value="بروزرسانی سبد خرید">بروزرسانی سبد خرید</button>
